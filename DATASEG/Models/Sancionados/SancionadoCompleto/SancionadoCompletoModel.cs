namespace DATASEG.Models.Sancionados.SancionadoCompleto
{
    public class SancionadoCompletoModel
    {
        public string? estado { get; set; }
        public IEnumerable<SancionadosModel> declaracionesModels { get; set; }
    }
